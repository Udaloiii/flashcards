...
//     {/*заменил в svg width={24} height={24} на viewBox="0 0 24 24" для коррекн.отображения картинки*/}
//     <g fill={props.color}>
//       {/*поменял значение fill на props.color*/}
//       {/*удалил clipPath*/}
//       <path
//         fill="#000"
...
import { SVGProps, Ref, forwardRef, memo } from 'react'
const SvgComponent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none" ref={ref} {...props}>
    <g>
      <path
        // fill="#000"
        fill={props.color}
